...
register_perk()
{
	...
	perk_struct.hint_string = &"ZOMBIE_PERK_VULTURE";
	perk_struct.perk_bottle = "zombie_perk_bottle_vulture";
	perk_struct.perk_shader = "specialty_vulture_zombies";
	...
	if ( isDefined( level.perk_precache_override_funcs[ "specialty_nomotionsensor" ] ) )
	{
		perk_struct.precache_func = level.perk_precache_override_funcs[ "specialty_nomotionsensor" ];
	}
	else 
	{
		perk_struct.precache_func = ::vulture_precache;
	}
	perk_struct.clientfield_register = ::vulture_register_clientfield;
	perk_struct.clientfield_set = ::vulture_set_clientfield;
	perk_struct.funcs = [];
	if ( isDefined( level.perk_kvps_override_funcs[ "specialty_nomotionsensor" ] ) )
	{
		perk_struct.perk_machine_set_kvps = level.perk_kvps_override_funcs[ "specialty_nomotionsensor" ];
	}
	else 
	{
		perk_struct.perk_machine_set_kvps = ::vulture_perk_machine_setup;
	}
	perk_struct.player_thread_give = ::give_vulture_perk;
	perk_struct.player_thread_take = ::take_vulture_perk;
	perk_struct.alias = "vulture";
	maps/mp/zombies/_zm_perks::register_perk_basic_info( "specialty_nomotionsensor", perk_struct );
}
...
vulture_precache()
{
	...
	level.machine_assets[ "specialty_nomotionsensor" ] = spawnstruct();
	level.machine_assets[ "specialty_nomotionsensor" ].off_model = "p6_zm_vending_vultureaid";
	level.machine_assets[ "specialty_nomotionsensor" ].on_model = "p6_zm_vending_vultureaid_on";
}
